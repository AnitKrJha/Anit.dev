...
Now, pop open the terminal and type:

```bash
sudo nautilus
```

This opens your file explorer in admin mode. Copy the extracted folder and navigate to `/boot/grub2/themes`. Paste it there.
...
Almost there! Run these two commands:
